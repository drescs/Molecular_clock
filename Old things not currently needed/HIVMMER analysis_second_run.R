...
mypath="O:/JOLabShared/SaraDrescher/Molecular_clock/nano"
...
writeLines(c(noquote("#!/bin/sh"), noquote("cd /home/sdresche/JOLabShared/SaraDrescher/Molecular_clock"), write_HIVMMER_Command(c(66,67,68, 80,81), expname="second_run", sample_namesdb=sample_names, datapath=mypath)), fileConn)
close(fileConn)
...
write.csv(third_output, file="C:/Users/Sara/Documents/HHMI_projects/Molecular_clock/Analysis/third_output_second_run.csv")
